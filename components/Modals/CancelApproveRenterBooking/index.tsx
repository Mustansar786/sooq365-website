...
export type CancelApproveRenterBookingModalHandle = {
    open: (rejectOptions:any, bookingId:string, callback:()=>void) => void,
}

const CancelApproveBookingModal: React.ForwardRefRenderFunction<CancelApproveRenterBookingModalHandle> = (_, ref) => {
        ...
        >
            <Modal.Content >
                <Modal.Description >
                    ...
                    <p>{t("Please note that cancellations may take up to 7 working days to be processed and are subject to the host’s policies. Please contact your host in order to avoid any inconvenices.")}</p>
...
<Modal
    ...
    >
      ...
      <Modal.Actions>
        {/* <Button color='black' onClick={() => setRefundStatusModal(false)}>
          Cancel
        </Button> */}
        <Button
          content="Ok"
...
export default forwardRef(CancelApproveBookingModal);
